...
class Order(UUIDMixin, TimestampMixin, Base):
    ...
    customer_id: Mapped[str | None] = mapped_column(ForeignKey("profiles.id"), nullable=True, index=True)
    ...
    # Relationships
    customer: Mapped["Profile | None"] = relationship(back_populates="orders", lazy="selectin")
